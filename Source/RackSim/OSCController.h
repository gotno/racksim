...
UCLASS()
class RACKSIM_API AOSCController : public AActor {
	GENERATED_BODY()
...
private:
  ...
  UFUNCTION()
  void DestroyCable(const FOSCAddress& AddressPattern, const FOSCMessage &message, const FString &ipaddress, int32 port);
  UFUNCTION()
